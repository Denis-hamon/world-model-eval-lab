"""Pool per-seed Cartpole CPG JSONs into a single pooled-N report.
...
Writes (for --model-size 5 --seeds 0 1 2):
    results/dmc_cartpole/tdmpc2_cpg_size5_pooled.json
    results/dmc_cartpole/coverage_mlp_on_tdmpc2_cpg_size5_pooled.json
    results/dmc_cartpole/cem_cpg_size5_pooled.json
"""
