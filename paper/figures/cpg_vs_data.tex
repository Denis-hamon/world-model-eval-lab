...
%   data=20000  val_mse=0.0004  CPG=+0.267  AC 95% CI [+0.191, +0.335]
%
% AC CI half-width = 0.072 (symmetric around the AC midpoint 0.263; the raw
% CPG point 0.267 sits ~0.004 above the AC midpoint due to the plus-4
% adjustment, so the symmetric whiskers around 0.267 approximate the AC
% interval to within that 0.004).
\begin{figure}[t]
  \centering
  \begin{tikzpicture}
    \pgfplotsset{
    ...
    \begin{axis}[
      ...
      \addplot[color=red!75!black, mark=square*, thick]
        coordinates {(200, 0.0651) (2000, 0.0233) (20000, 0.0004)};
